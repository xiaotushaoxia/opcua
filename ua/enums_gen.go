...
func IdentityCriteriaTypeFromString(s string) IdentityCriteriaType {
	switch s {
		...
		case "Application": return 7
		case "X509Subject": return 8
		default:
		return 0
	}
}
...
func AlarmMaskFromString(s string) AlarmMask {
	switch s {
		...
		case "Unacknowledged": return 2
		case "Unconfirmed": return 4
		default:
		return 0
	}
}
...
func TrustListValidationOptionsFromString(s string) TrustListValidationOptions {
	switch s {
		case "None": return 0
		case "SuppressCertificateExpired": return 1
		case "SuppressHostNameInvalid": return 2
		case "SuppressRevocationStatusUnknown": return 4
		case "SuppressIssuerCertificateExpired": return 8
		case "SuppressIssuerRevocationStatusUnknown": return 16
		case "CheckRevocationStatusOnline": return 32
		case "CheckRevocationStatusOffline": return 64
		default:
		return 0
	}
}
...
func JSONDataSetMessageContentMaskFromString(s string) JSONDataSetMessageContentMask {
	switch s {
		...
		case "MessageType": return 32
		case "DataSetWriterName": return 64
		case "ReversibleFieldEncoding": return 128
		default:
		return 0
	}
}
...
func PubSubConfigurationRefMaskFromString(s string) PubSubConfigurationRefMask {
	switch s {
		case "None": return 0
		case "ElementAdd": return 1
		case "ElementMatch": return 2
		case "ElementModify": return 4
		case "ElementRemove": return 8
		case "ReferenceWriter": return 16
		case "ReferenceReader": return 32
		case "ReferenceWriterGroup": return 64
		case "ReferenceReaderGroup": return 128
		case "ReferenceConnection": return 256
		case "ReferencePubDataset": return 512
		case "ReferenceSubDataset": return 1024
		case "ReferenceSecurityGroup": return 2048
		case "ReferencePushTarget": return 4096
		default:
		return 0
	}
}
...
func PasswordOptionsMaskFromString(s string) PasswordOptionsMask {
	switch s {
		case "None": return 0
		case "SupportInitialPasswordChange": return 1
		case "SupportDisableUser": return 2
		case "SupportDisableDeleteForUser": return 4
		case "SupportNoChangeForUser": return 8
		case "SupportDescriptionForUser": return 16
		case "RequiresUpperCaseCharacters": return 32
		case "RequiresLowerCaseCharacters": return 64
		case "RequiresDigitCharacters": return 128
		case "RequiresSpecialCharacters": return 256
		default:
		return 0
	}
}
...
func UserConfigurationMaskFromString(s string) UserConfigurationMask {
	switch s {
		...
		case "NoChangeByUser": return 4
		case "MustChangePassword": return 8
		default:
		return 0
	}
}
...
func InterfaceOperStatusFromString(s string) InterfaceOperStatus {
	switch s {
		...
		case "NotPresent": return 5
		case "LowerLayerDown": return 6
		default:
		return 0
	}
}
...
func TsnFailureCodeFromString(s string) TsnFailureCode {
	switch s {
		case "NoFailure": return 0
		case "InsufficientBandwidth": return 1
		case "InsufficientResources": return 2
		case "InsufficientTrafficClassBandwidth": return 3
		case "StreamIdInUse": return 4
		case "StreamDestinationAddressInUse": return 5
		case "StreamPreemptedByHigherRank": return 6
		case "LatencyHasChanged": return 7
		case "EgressPortNotAvbCapable": return 8
		case "UseDifferentDestinationAddress": return 9
		case "OutOfMsrpResources": return 10
		case "OutOfMmrpResources": return 11
		case "CannotStoreDestinationAddress": return 12
		case "PriorityIsNotAnSrcClass": return 13
		case "MaxFrameSizeTooLarge": return 14
		case "MaxFanInPortsLimitReached": return 15
		case "FirstValueChangedForStreamId": return 16
		case "VlanBlockedOnEgress": return 17
		case "VlanTaggingDisabledOnEgress": return 18
		case "SrClassPriorityMismatch": return 19
		case "FeatureNotPropagated": return 20
		case "MaxLatencyExceeded": return 21
		case "BridgeDoesNotProvideNetworkId": return 22
		case "StreamTransformNotSupported": return 23
		case "StreamIdTypeNotSupported": return 24
		case "FeatureNotSupported": return 25
		default:
		return 0
	}
}
...
func AccessLevelExTypeFromString(s string) AccessLevelExType {
	switch s {
		...
		case "NoSubDataTypes": return 2048
		case "NonVolatile": return 4096
		case "Constant": return 8192
		default:
		return 0
	}
}
...
func AccessRestrictionTypeFromString(s string) AccessRestrictionType {
	switch s {
		...
		case "ApplyRestrictionsToBrowse": return 8
		default:
		return 0
	}
}
...
func StructureTypeFromString(s string) StructureType {
	switch s {
		...
		case "Union": return 2
		case "StructureWithSubtypedValues": return 3
		case "UnionWithSubtypedValues": return 4
		default:
		return 0
	}
}
